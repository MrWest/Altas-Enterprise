...
namespace CompanyName.Atlas.Investments.Tests.Implementation.Application
{
    ...
    public class BudgetComponentItemManagerApplicationServicesBaseTests :
        ItemManagerApplicationServicesTestsBase<BudgetComponentItemManagerApplicationServicesBaseTests.BudgetComponentItemManagerApplicationServicesStub, IBudgetComponentItem, IBudgetComponentItemRepository<IBudgetComponentItem>, IBudgetComponentItemDomainServices<IBudgetComponentItem>, IUnitOfWork>
    {
        //[TestInitialize]
        ...
        //{
        //    // Arrange
        //    var component = Mock.Of<IBudgetComponent>(x => x.Id == 1.ToString());
        //    TestObject.Component = component;
        ...
        public class BudgetComponentItemManagerApplicationServicesStub :
            BudgetComponentItemManagerApplicationServicesBase<IBudgetComponentItem, IBudgetComponentItemRepository<IBudgetComponentItem>, IBudgetComponentItemDomainServices<IBudgetComponentItem>>
        {
            public IBudgetComponentItemRepository<IBudgetComponentItem> GetRepository()
            {
                return Repository;
            }

            public IBudgetComponentItemDomainServices<IBudgetComponentItem> GetDomainServices()
            {
                return DomainServices;
            }

            public override IBudgetComponentItem Export(IDatabaseContext exportDatabaseContext, IBudgetComponentItem item)
            {
