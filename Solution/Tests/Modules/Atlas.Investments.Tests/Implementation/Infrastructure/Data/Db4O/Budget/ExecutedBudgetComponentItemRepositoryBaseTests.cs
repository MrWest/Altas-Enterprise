...
namespace CompanyName.Atlas.Investments.Tests.Implementation.Infrastructure.Data.Db4O.Budget
{
    ...
    //        IPlannedResource plannedResource = new PlannedResourceStub { Id = Guid.NewGuid().ToString(), Component = budgetComponent };
    ...
    //        var executedItem = new ExecutedResourceStub { Id = Guid.NewGuid().ToString(), Planification = plannedItem };
