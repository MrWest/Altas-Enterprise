...
namespace CompanyName.Atlas.Investments.Tests.Implementation.Domain.Services
{
    ...
    public class BudgetComponentItemDomainServicesBaseTests : DomainServicesTestsBase<IBudgetComponentItem, BudgetComponentItemDomainServicesBase<IBudgetComponentItem>>
    {
        [TestInitialize]
