...
namespace CompanyName.Atlas.Investments.Tests.UnitTests.Implementation.Infrastructure.Data.Db4O.Budget
{
    ...
    public class ExecutedActivityRepositoryBaseTests : TestBase
    {
        ...
        public void Add_GivenExecutedActivityWithPlanification_RelatesItToThatPlanification()
        {
            ...
            IPlannedActivity plannedActivity = new PlannedActivityStub { Id = Guid.NewGuid() };
            budgetComponent.PlannedActivities.Add(plannedActivity);
        ...
        {
            // Arrange
            var repository = new Mock<ExecutedActivityRepositoryBase<IBudgetComponent>>(Mock.Of<IDb4ODatabaseContext>()) { CallBase = true };
        ...
        public void Update_GivenExecutedActivityWithNullPlanification_BreaksTheRelationshipWithItsActualOne()
        {
            // Arrange
            IBudgetComponent budgetComponent = new BudgetComponentStub { Id = Guid.NewGuid() };
            IPlannedActivity planification = new PlannedActivityStub { Id = Guid.NewGuid() };
            IExecutedActivity executedActivity = new ExecutedActivityStub
            {
                Id = Guid.NewGuid(),
                Component = budgetComponent,
        ...
        public void Update_GivenExecutedActivityWithAnotherPlanification_BreaksTheRelationshipWithItsActualOneAndEstablishesARelationshipWithTheCurrentOne()
        {
            // Arrange
            IBudgetComponent budgetComponent = new BudgetComponentStub { Id = Guid.NewGuid() };
            IPlannedActivity oldPlanification = new PlannedActivityStub { Id = Guid.NewGuid() };
            IExecutedActivity executedActivity = new ExecutedActivityStub
            {
                Component = budgetComponent,
                Id = Guid.NewGuid(),
            ...
            // Act
            IExecutedActivity oldExecution = new ExecutedActivityStub { Id = Guid.NewGuid() };
            IPlannedActivity newPlanification = new PlannedActivityStub { Id = Guid.NewGuid(), Execution = oldExecution };
            ...
            using (var db = Db4oEmbedded.OpenFile(_dbPath))
            {
                ...
                Assert.AreSame(newPlanification, executedActivity.Planification);
                Assert.AreSame(executedActivity, newPlanification.Execution);
        ...
        public void Update_GivenExecutedActivity_RestoresRelationshipWithItsComponentIfSuchRelationshipIsBroken()
        {
            // Arrange
            IBudgetComponent budgetComponent = new BudgetComponentStub { Id = Guid.NewGuid() };
            IExecutedActivity executedActivity = new ExecutedActivityStub { Component = budgetComponent, Id = Guid.NewGuid() };
            budgetComponent.ExecutedActivities.Add(executedActivity);
            ...
            using (var db = new Db4ODatabaseContext(_dbPath))
            {
                ...
                dbExecutedActivity.Component = null;
            ...
            using (var db = Db4oEmbedded.OpenFile(_dbPath))
            {
                ...
                Assert.AreSame(component, executedActivity.Component);
        ...
        public void Relate_GivenNullPlannedActivity_Throws()
        {
            // Arrange
            var db = Mock.Of<IDb4ODatabaseContext>();
            var repository = new Mock<ExecutedActivityRepositoryBase<IBudgetComponent>>(db) { CallBase = true };

            // Act
            repository.Object.Relate(Mock.Of<IExecutedActivity>(), (IPlannedActivity)null);
        }
        ...
        public void Relate_GivenNullExecutedActivity_Throws()
        {
            ...
            // Act
            repository.Object.Relate(null, Mock.Of<IPlannedActivity>());
        }
        ...
        public void Unrelate_GivenNullPlannedActivity_Throws()
        {
            ...
            // Act
            repository.Object.Unrelate(Mock.Of<IExecutedActivity>(), (IPlannedActivity)null);
        }
        ...
        public void Unrelate_GivenNullExecutedActivity_Throws()
        {
            ...
            // Act
            repository.Object.Unrelate(null, Mock.Of<IPlannedActivity>());
        }
        ...
        public void SaveReference_GivenNullPlannedActivity_Throws()
        {
            ...
            // Act
            repository.Object.SaveReference((IPlannedActivity)null);
        }


        public class RepositoryStub : ExecutedActivityRepositoryBase<IBudgetComponent>
        {
