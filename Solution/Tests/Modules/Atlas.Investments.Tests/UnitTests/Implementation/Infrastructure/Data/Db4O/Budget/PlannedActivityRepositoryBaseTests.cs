...
namespace CompanyName.Atlas.Investments.Tests.UnitTests.Implementation.Infrastructure.Data.Db4O.Budget
{
    ...
    public class PlannedActivityRepositoryBaseTests
    {
        ...
        public void GetItemCollection_ReturnsMethodAllowingToObtainCorrectPlannedActivityListOfCurrentBudgetComponent()
        {
            ...
            var budgetComponent = Mock.Of<IBudgetComponent>(x => x.PlannedActivities == expectedList);
        ...
        public class RepositoryStub : PlannedActivityRepositoryBase<IBudgetComponent>
        {
