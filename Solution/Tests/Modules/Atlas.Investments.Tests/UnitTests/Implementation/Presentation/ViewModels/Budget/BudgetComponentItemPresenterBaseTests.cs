...
namespace CompanyName.Atlas.Investments.Tests.UnitTests.Implementation.Presentation.ViewModels.Budget
{
    ...
    public class BudgetComponentItemPresenterBaseTests :
        PresenterTestsBase<IBudgetComponentItem, BudgetComponentItemPresenterBaseTests.BudgetComponentItemPresenterStub, IBudgetComponentItemManagerApplicationServices<IBudgetComponentItem, IBudgetComponent>>
    {
        [TestInitialize]
        ...
        public class BudgetComponentItemPresenterStub : BudgetComponentItemPresenterBase<IBudgetComponentItem, IBudgetComponent, IBudgetComponentItemManagerApplicationServices<IBudgetComponentItem, IBudgetComponent>>
        {
            public BudgetComponentItemPresenterStub(IBudgetComponentItem item)
                : base(item)
            {
            }
