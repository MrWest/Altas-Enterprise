...
namespace CompanyName.Atlas.Investments.Tests.UnitTests.Implementation.Presentation.ViewModels.Budget
{
    ...
    public class BudgetComponentItemViewModelBaseTests :
        CrudViewModelTestsBase<BudgetComponentItemViewModelBaseTests.BudgetComponentItemViewModelStub, IBudgetComponentItem, IBudgetComponentItemPresenter<IBudgetComponentItem, IBudgetComponent>, IBudgetComponentItemManagerApplicationServices<IBudgetComponentItem, IBudgetComponent>>
    {
        [TestInitialize]
        public override void Initialize()
        {
            ...
            ServiceLocatorMock.Setup(x => x.GetInstance<IBudgetComponentItemPresenter<IBudgetComponentItem, IBudgetComponent>>()).Returns(() =>
            {
                var mock = new Mock<IBudgetComponentItemPresenter<IBudgetComponentItem, IBudgetComponent>>();
        ...
        public void CreatePresenterFor_ReturnsPresenterWithComponentCorrectlyInitialized()
        {
            ...
            // Act
            var presenter = (IBudgetComponentItemPresenter<IBudgetComponentItem, IBudgetComponent>)TestObjectInternals.Invoke("CreatePresenterFor", Mock.Of<IBudgetComponentItem>());
        ...
        public void FilterCommand_CanExecute_AfterAChangeInABudgetComponentItem_TriggersAFilter()
        {
            ...
            var item = new Mock<IBudgetComponentItemPresenter<IBudgetComponentItem, IBudgetComponent>>();
        ...
        {
            // Act
            TestObject.Add(Mock.Of<IBudgetComponentItemPresenter<IBudgetComponentItem, IBudgetComponent>>());
        ...
        public class BudgetComponentItemViewModelStub : BudgetComponentItemViewModelBase<IBudgetComponentItem, IBudgetComponentItemPresenter<IBudgetComponentItem, IBudgetComponent>, IBudgetComponent, IBudgetComponentItemManagerApplicationServices<IBudgetComponentItem, IBudgetComponent>>
        {
        }
    }
}