...
using CompanyName.Atlas_App_Help.Presentation.Views;
...
namespace CompanyName.Atlas_App_Help
{
    /// <summary>
    ...
    public class ConfigurationSubsystem : SubsystemBase
    {
        ...
        /// </summary>
        public const string SubsystemName = "Atlas.Help_Content";
        ...
        {
            _logger.Log("Initializing module: Atlas_App_Help Subsystem..", Microsoft.Practices.Prism.Logging.Category.Debug, Priority.High);
            ...
            _logger.Log("Initialized module: Atlas_App_Help Subsystem", Microsoft.Practices.Prism.Logging.Category.Debug, Priority.Low);
        }
