...
namespace CompanyName.Atlas.Investments.Implementation.Application.Budget.Construction
{
    ...
    ///     planned resources of an construction budget component.
    /// </summary>
    public class ConstructionPlannedResourceManagerApplicationServices :
        BudgetComponentItemManagerApplicationServicesBase<IPlannedResource, IConstructionComponent, IConstructionPlannedResourceRepository, IConstructionPlannedResourceDomainServices>,
        IConstructionPlannedResourceManagerApplicationServices
    {
    }
}