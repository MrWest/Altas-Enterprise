...
{
    /// <summary>
    /// Implementation of the çontract <see cref="IEquipmentPlannedResourceRepository"/>, representing the repository that
    /// is used to handle the Data operations regarding the <see cref="IPlannedResource"/> of a certain
    /// <see cref="IEquipmentComponent"/>.
    /// </summary>
    public class EquipmentPlannedResourceRepository :
        PlannedResourceRepositoryBase<IEquipmentComponent>,
        IEquipmentPlannedResourceRepository
    {
        /// <summary>
        ...
        /// </param>
        public EquipmentPlannedResourceRepository(IDb4ODatabaseContext databaseContext)
