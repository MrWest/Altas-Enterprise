...
{
    /// <summary>
    /// Implementation of the çontract <see cref="IOtherExpensesPlannedResourceRepository"/>, representing the repository that
    ...
    /// </summary>
    public class OtherExpensesPlannedResourceRepository :
        PlannedResourceRepositoryBase<IOtherExpensesComponent>,
        IOtherExpensesPlannedResourceRepository
    {
        /// <summary>
        /// Initializes a new instance of <see cref="OtherExpensesPlannedResourceRepository"/> with a
        ...
        /// </param>
        public OtherExpensesPlannedResourceRepository(IDb4ODatabaseContext databaseContext)
