...
{
    /// <summary>
    /// Implementation of the çontract <see cref="IEquipmentPlannedActivityRepository"/>, representing the repository that
    /// is used to handle the Data operations regarding the <see cref="IPlannedActivity"/> of a certain
    /// <see cref="IEquipmentComponent"/>.
    /// </summary>
    public class EquipmentPlannedActivityRepository : 
        PlannedActivityRepositoryBase,
        IEquipmentPlannedActivityRepository
    {
        /// <summary>
        ...
        /// </param>
        public EquipmentPlannedActivityRepository(IDb4ODatabaseContext databaseContext)
