...
{
    /// <summary>
    /// Implementation of the çontract <see cref="IConstructionPlannedResourceRepository"/>, representing the repository that
    ...
    /// </summary>
    public class ConstructionPlannedResourceRepository : 
        PlannedResourceRepositoryBase<IConstructionComponent>,
        IConstructionPlannedResourceRepository
    {
        /// <summary>
        /// Initializes a new instance of <see cref="ConstructionPlannedResourceRepository"/> with a
        ...
        /// </param>
        public ConstructionPlannedResourceRepository(IDb4ODatabaseContext databaseContext)
