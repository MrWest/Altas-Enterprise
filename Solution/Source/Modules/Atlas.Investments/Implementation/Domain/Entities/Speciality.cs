...
namespace CompanyName.Atlas.Investments.Implementation.Domain.Entities
{
    ...
    /// </summary>
    public class Speciality : CodedNomenclatorBase, ISpeciality
    {
        ///// <summary>
        ...
        private IList<ISubSpeciality> _subExpenseConcept;
        public IList<ISubSpeciality> SubExpenseConcept {
            get
            {
                return _subExpenseConcept ?? new List<ISubSpeciality>();
            } 
        }
