...
namespace CompanyName.Atlas.Investments.Presentation.Views
{
    ...
    /// </summary>
    public partial class SubSpecialityHolderBothDataGrid : INotifyPropertyChanged
    {
        /// <summary>
        ...
        /// </summary>
        public static readonly DependencyProperty AllowDragDropProperty = DependencyProperty.Register("AllowDragDrop", typeof(bool), typeof(SubSpecialityHolderBothDataGrid), new PropertyMetadata(false));

        /// <summary>
        ///     Dependency property containing the command that allows to execute selected planned items in instance of
        ///     <see cref="BudgetComponentItemDataGrid" />.
        /// </summary>
        public static readonly DependencyProperty ExecutePlannedItemsCommandProperty = DependencyProperty.Register("ExecutePlannedItemsCommand", typeof(ICommand), typeof(SubSpecialityHolderBothDataGrid), new PropertyMetadata(new DisabledCommand()));

        /// <summary>
        /// Dependency property used to contain the string value containing the text to be displayed by the total summary.
        /// </summary>
        public static readonly DependencyProperty TotalTextProperty = DependencyProperty.Register("TotalText", typeof(string), typeof(SubSpecialityHolderBothDataGrid), new PropertyMetadata(Properties.Resources.Total));

        /// <summary>
        /// Dependency property to contain the total of som datagrig data to sumarize <see cref="SubSpecialityHolderBothDataGrid"/>.
        /// </summary>
        public static readonly DependencyProperty TotaldDependencyProperty = DependencyProperty.Register("Total", typeof(decimal), typeof(SubSpecialityHolderBothDataGrid), new PropertyMetadata(null));

        private TreeView _dragSource;


        public static readonly DependencyProperty AddResourceCommandProperty = DependencyProperty.Register("AddResourceCommand", typeof(ICommand), typeof(SubSpecialityHolderBothDataGrid), new PropertyMetadata(null));
        ...
        /// </summary>
        public static readonly DependencyProperty DeleteResourceCommandProperty = DependencyProperty.Register("DeleteResourceCommand", typeof(ICommand), typeof(SubSpecialityHolderBothDataGrid), new PropertyMetadata(null));

        /// <summary>
        /// Dependency property to contain the command that is executed by the Add Button of the current <see cref="AtlasDataGrid"/>.
        /// </summary>
        public static readonly DependencyProperty AddButtonCommandProperty = DependencyProperty.Register("AddButtonCommand", typeof(ICommand), typeof(SubSpecialityHolderBothDataGrid), new PropertyMetadata(null));

        /// <summary>
        /// Dependency property used to contain the string value containing the text to be displayed by the Add button.
        /// </summary>
        public static readonly DependencyProperty AddButtonTextProperty = DependencyProperty.Register("AddButtonText", typeof(string), typeof(SubSpecialityHolderBothDataGrid), new PropertyMetadata(Properties.Resources.Add));
        
        /// <summary>
        ///     Dependency property containing the command that allows to execute selected planned items in instance of
        ///     <see cref="BudgetComponentItemDataGrid" />.
        /// </summary>
        public static readonly DependencyProperty AddPlannedItemsCommandProperty = DependencyProperty.Register("AddPlannedItemsCommand", typeof(ICommand), typeof(SubSpecialityHolderBothDataGrid), new PropertyMetadata(new DisabledCommand()));

        /// <summary>
        /// Dependency property holding the value saying whether a <see cref="InvestmentElementTreeView"/> is collased or not.
        /// </summary>
        public static readonly DependencyProperty ShowRowDetailProperty = DependencyProperty.Register("ShowRowDetail", typeof(bool), typeof(SubSpecialityHolderBothDataGrid), new PropertyMetadata(true));

        /// <summary>
        /// Dependency property containing the Filter command for instances of <see cref="FilterBox"/>.
        /// </summary>
        public static readonly DependencyProperty ShowTotalProperty = DependencyProperty.Register("ShowTotal", typeof(Visibility), typeof(SubSpecialityHolderBothDataGrid));

        /// <summary>
        /// Dependency property containing the Filter command for instances of <see cref="FilterBox"/>.
        /// </summary>
        public static readonly DependencyProperty VersionColumnWidthProperty = DependencyProperty.Register("VersionColumnWidth", typeof(GridLength), typeof(SubSpecialityHolderBothDataGrid),new PropertyMetadata(new GridLength(30,GridUnitType.Auto)));


        /// <summary>
        ///     Initializes a new instance of <see cref="BudgetComponentItemDataGrid" />.
        /// </summary>
        public SubSpecialityHolderBothDataGrid ()
        {
        ...
        ///     <see cref="BudgetComponentItemDataGrid" />.
        /// </summary>
        public static readonly DependencyProperty CodeColumnWidthProperty = DependencyProperty.Register("CodeColumnWidth", typeof(double), typeof(SubSpecialityHolderBothDataGrid), new PropertyMetadata((double)100));
