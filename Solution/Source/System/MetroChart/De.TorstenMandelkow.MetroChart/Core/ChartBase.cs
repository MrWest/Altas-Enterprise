...
using De.TorstenMandelkow.MetroChart.ChartControls;

namespace De.TorstenMandelkow.MetroChart.Core
{
#if NETFX_CORE
    ...
    public abstract class ChartBase : Control, INotifyPropertyChanged
    {
        ...
        public static readonly DependencyProperty SelectedBrushProperty =
            ...
            typeof(Brush), typeof(ChartBase), new PropertyMetadata(new LinearGradientBrush(Color.FromArgb(255,255,182,20), Colors.Orange, 45)));
