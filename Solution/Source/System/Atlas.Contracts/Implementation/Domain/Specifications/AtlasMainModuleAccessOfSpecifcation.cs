...
{
    public class AtlasMainModuleAccessOfSpecifcation : Specification<IAtlasMainModuleAccess>
    {
        /// <summary>
        ...
        public AtlasMainModuleAccessOfSpecifcation(String ownerModuleAccess)
        {
            if (ownerModuleAccess == null)
                throw new ArgumentNullException("ownerModuleAccess");

            Predicate = acces => acces.AssemblyName != null && Equals(acces.AssemblyName, ownerModuleAccess);
        }
    }
}
